...
The Chinese is the original source of truth. Keep every zh value verbatim and add faithful English translations.

Rules:
- Every user-facing text field becomes {{"zh":"<原始中文>","en":"<English translation>"}}.
- Translate: course.title, course.tagline, course.spine, course.thesis, course.audience, course.whyThisOrder, archDiagram.caption, section title/summary/spine/role/transitionIn/transitionOut, and lesson title/theProblem/objective/mechanism/whyNow/missingBefore/nextPressure.
...
Rules:
- Every user-facing text field becomes {{"zh":"<原始中文>","en":"<English translation>"}}.
- Translate: principle, teachingScope, problem, solution, diagram.caption, each howItWorks title/desc/anatomy, deepDive, deepSource, sourceCompare.simplified, sourceCompare.real, every sourceCompare.gaps field, tryIt setup/commands/observe items, references.whyUsed, whatsNext, and compare.rows labels.
